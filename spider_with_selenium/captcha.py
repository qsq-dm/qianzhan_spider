...
def _format_img(img_file):
    ...
    # vector = (0, 0, 0, 2, 3, 3, 5, 6, 8, 8, 8, 8, 8, 8, 6, 6, 6, 5, 3, 2,
    #           0, 0, 0, -2, -3, -3, -5, -6, -8, -8, -8, -8, -8, -8, -6, -6, -6, -5, -3, -2)  # 右移向量
    vector = [0, 0, 1, 2, 3, 4, 5, 5, 5, 5, 4, 4, 3, 1,
              0, 0, -1, -2, -3, -4, -5, -5, -5, -5, -4, -4, -3, -1]  # 右移向量
...
def read_img_file_to_string(img_file):
    return pytesseract.image_to_string(Image.open(_format_img(img_file)))
